 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Fi(e){k(new $("platform-logger",t=>new Zs(t),"PRIVATE")),k(new $("heartbeat",t=>new Ri(t),"PRIVATE")),M(Et,Vt,e),M(Et,Vt,"esm2020"),M("fire-js","")}Fi("");var zi="firebase",Hi="12.3.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Me=1e4,$e=`w:${Dt}`,Re="FIS_v2",Ui="https://firebaseinstallations.googleapis.com/v1",ji=3600*1e3,Gi="installations",Vi="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
