 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const As=1e3,Ds=2,Os=14400*1e3,Bs=.5;function Ht(e,t=As,n=Ds){const s=t*Math.pow(n,e),i=Math.round(Bs*s*(Math.random()-.5)*2);return Math.min(Os,s+i)}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Zs{constructor(t){this.container=t}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(Js(n)){const s=n.getImmediate();return`${s.library}/${s.version}`}else return null}).filter(n=>n).join(" ")}}function Js(e){return e.getComponent()?.type==="VERSION"}const Et="@firebase/app",Gt="0.14.3";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Di="firebase-heartbeat-database",Oi=1,G="firebase-heartbeat-store";let ht=null;function De(){return ht||(ht=Le(Di,Oi,{upgrade:(e,t)=>{switch(t){case 0:try{e.createObjectStore(G)}catch(n){console.warn(n)}}}}).catch(e=>{throw B.create("idb-open",{originalErrorMessage:e.message})})),ht}async function Bi(e){try{const n=(await De()).transaction(G),s=await n.objectStore(G).get(Oe(e));return await n.done,s}catch(t){if(t instanceof H)D.warn(t.message);else{const n=B.create("idb-get",{originalErrorMessage:t?.message});D.warn(n.message)}}}async function Wt(e,t){try{const s=(await De()).transaction(G,"readwrite");await s.objectStore(G).put(t,Oe(e)),await s.done}catch(n){if(n instanceof H)D.warn(n.message);else{const s=B.create("idb-set",{originalErrorMessage:n?.message});D.warn(s.message)}}}function Oe(e){return`${e.name}!${e.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Fi(e){k(new $("platform-logger",t=>new Zs(t),"PRIVATE")),k(new $("heartbeat",t=>new Ri(t),"PRIVATE")),M(Et,Gt,e),M(Et,Gt,"esm2020"),M("fire-js","")}Fi("");var zi="firebase",Hi="12.3.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */M(zi,Hi,"app");const Be="@firebase/installations",Dt="0.6.19";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Me=1e4,$e=`w:${Dt}`,Re="FIS_v2",Ui="https://firebaseinstallations.googleapis.com/v1",ji=3600*1e3,Vi="installations",Gi="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const je=new Map;function Ve(e,t){const n=it(e);Ge(n,t),er(n,t)}function Ge(e,t){const n=je.get(e);if(n)for(const s of n)s(t)}function er(e,t){const n=nr();n&&n.postMessage({key:e,fid:t}),sr()}let N=null;function nr(){return!N&&"BroadcastChannel"in self&&(N=new BroadcastChannel("[Firebase] FID Change"),N.onmessage=e=>{Ge(e.data.key,e.data.fid)}),N}function sr(){je.size===0&&N&&(N.close(),N=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const I=new Se("@firebase/analytics");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
